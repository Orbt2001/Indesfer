...
<header id="header">
	<div class="container-fluid">
		<div class="logobar"><a href="index">
			<img class="" src="img/logo.png" width="100" alt=""></a>
		</div>
		<nav id="nav-menu-container">

			<ul class="nav-menu">
				<li class="item-menu"><a href="index">Inicio</a></li>
				<li class="item-menu"><a href="#catalogo">Catalogo</a></li>
				<li class="item-menu"><a href="#clients">Clientes</a></li>
				<li class="item-menu"><a href="#contact">Contatos</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
			</ul>
...
$text_solda = 'Estanho para soldagem de calhas, radiadores, tubos de cobre, painéis de chapa de zinco,aparelhos de refrigeração e estanhagem de pecas em geral. Produzidas com estanho e chumbo de alta pureza com aproximadamente 100g por verga.';
$arr_produtos = [
    'termo' => [
    ...
    'Solda de estanho artesanal e convencional'=>[
        'nome'=>'Solda de estanho artesanal e convencional',
        'descricao' => $text_solda,
        'codigo'=> '0007',
        'tamanho' => 'Sob Medida',
