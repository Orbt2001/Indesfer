 <!--==========================
    ...
    <footer id="footer">
    			...
    			<div class="row">
    				...
    				<div class="col-lg-3 col-md-5 footer-links">
    					...
    					<ul>
							...
							<li><i class="ion-ios-arrow-right"></i> <a href="index?id=&type=Orçamento#contact">Orçamento</a></li>
    					</ul>
    				</div>
    				...
    				<div class="col-lg-3 col-md-6 footer-contact">
    					<h4>Contatos</h4>
    					<p>
    						AV. PRAÇA DOS TRABALHADORES, 238
    						CECAP - Guariba - São Paulo - Brasil
    						CEP 14.840.000 <br>
    						<strong>Telefone:</strong> (16) 3251-8316<br>
    						<strong>E-mail:</strong> comercial@indesfer.com.br<br>
    					</p>

    					<div class="social-links">
    						<a href="https://www.facebook.com/indesfergecalhas" class="facebook"><i class="fa fa-facebook"></i></a>
    						<a href="https://www.instagram.com/indesfer_corte" class="instagram"><i class="fa fa-instagram"></i></a>
    						<a href="mailto:comercial@indesfer.com.br" class="envelope"><i class="fa fa-envelope"></i></a>
    					</div>
    	...
    	<div class="container">
    		<div class="copyright">
    			&copy; Copyright <strong>Indesfer</strong>. Todos Direitos Reservados
    		</div>
    		<div class="credits">
    			feito por <a href="https://orbt.com.br.com/">Orbt</a>
    		</div>
    	</div>
	</footer><!-- #footer -->
